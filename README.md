# Trivia
Desarrollado por Jose Ramirez y Bairon Sandoval
## Índice

* [1. Resumen del proyecto](#1-resumen-del-proyecto)
* [2. Como se desarrollo](#2-camo-se-desarrollo)
* [3. aprendizaje](#3-aprendizaje)
...
Esta es un juego de trivia donde se evalua el conocimiento acerca de paises y capitales. Dandole al usuario opciones de respuestas.

## 2. Como se desarrollo

iniciamos diseñando el prototipo final atravez de una herramienta de diseño, en la cual nos basamos para construir la estructura visual y funcional del juego
...
![](./img/pantallaFinal.PNG)

**Resultado Final**

Pantalla 1

![](./img/pantalla1-rs.PNG)

Pantalla alerta escribe tu nombre, se muestra en caso de que no se coloque ningun nombre

![](./img/pantalla-alerta-nombre.PNG)

Pantalla 2

![](./img/pantalla-pregunta1.PNG)

Pantalla alerta selecciona respuesta, se muestra en caso que no se coloque ninguna respuesta

![](./img/pantalla-alerta-selecciona-respuesta.PNG)

Pantalla final

![](./img/pantalla-final-rs.PNG)
